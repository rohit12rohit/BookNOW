...
const SearchResultsPage = lazy(() => import('./pages/SearchResultsPage')); // Ensure this line is present and correct
        ...
        <Box component="main" sx={{ flexGrow: 1, py: {xs: 1, sm: 2, md:3} }}>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/search" element={<SearchResultsPage />} /> {/* Route for search results */}
              <Route path="/book/:showtimeId" element={<BookingPage />} />
              <Route path="/organizer/events/new" element={ <ProtectedRoute allowedRoles={['organizer', 'admin']}> <OrganizerEventFormPage mode="create" /> </ProtectedRoute> } />
              <Route path="/organizer/events/edit/:eventId" element={ <ProtectedRoute allowedRoles={['organizer', 'admin']}> <OrganizerEventFormPage mode="edit" /> </ProtectedRoute> } />
