...
import { createBookingApi, cancelPendingBookingApi } from '../api/bookings'; // Import new cancel function
...
const BookingPage = () => {
    ...
    const [pendingBookingId, setPendingBookingId] = useState(null); // To store ID for cancellation
    ...
    const handleProceed = async () => {
        ...
        try {
            ...
            setPendingBookingId(pendingBooking._id); // Store for potential cancellation
            ...
            const options = {
                ...
                modal: {
                    ondismiss: async function() {
                        ...
                        setIsBooking(false);
                        setSelectedSeats([]); // Clear selected seats on cancellation
                    }
                }
            };
            ...
            setIsBooking(false);
            // If booking creation failed, there's nothing to cancel.
        }
    };
