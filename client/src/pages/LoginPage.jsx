// client/src/pages/LoginPage.jsx (Corrected handleSubmit)
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
         // --- CORRECTED LOGIC ---
         // The login function in context now returns true/false
         ...
         // This catch block is less likely needed if context handles errors,
         // but kept as a fallback for unexpected issues during the call itself.
