...
import ReportedReviewsOrganizer from '../components/organizer/ReportedReviewsOrganizer'; 
...
const OrganizerDashboardPage = () => {
    ...
    const getInitialTab = () => {
        ...
        const tabMap = { 'venues': 0, 'showtimes': 1, 'events': 2, 'bookings': 3, 'settings': 4, 'settings': 5 };
            ...
            <Paper elevation={3} sx={{width: '100%'}}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    ...
                    >
                        ...
                        <Tab icon={<ReportIcon />} iconPosition="start" label="Reported Reviews" {...a11yProps(4)} />
                        <Tab icon={<SettingsIcon />} iconPosition="start" label="Profile/Settings" {...a11yProps(5)} />
                    </Tabs>
                </Box>
                ...
                <TabPanel value={currentTab} index={4}> <ReportedReviewsOrganizer /> </TabPanel>
                <TabPanel value={currentTab} index={5}> <OrganizerProfileSettings /> </TabPanel>
            </Paper>
        </Container>
    );
};
